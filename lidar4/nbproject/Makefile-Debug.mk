...
LDLIBSOPTIONS=-lbcm2835 -lpthread -lwiringPi
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lidar4: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lidar4 ${OBJECTFILES} ${LDLIBSOPTIONS} librplidar_sdk.a -pthread

${OBJECTDIR}/include/IMU/ADXL345.o: include/IMU/ADXL345.cpp
	${MKDIR} -p ${OBJECTDIR}/include/IMU
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude/IMU -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/IMU/ADXL345.o include/IMU/ADXL345.cpp

${OBJECTDIR}/include/IMU/HMC5883L.o: include/IMU/HMC5883L.cpp
	${MKDIR} -p ${OBJECTDIR}/include/IMU
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude/IMU -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/IMU/HMC5883L.o include/IMU/HMC5883L.cpp

${OBJECTDIR}/include/IMU/I2Cdev.o: include/IMU/I2Cdev.cpp
	${MKDIR} -p ${OBJECTDIR}/include/IMU
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude/IMU -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/IMU/I2Cdev.o include/IMU/I2Cdev.cpp
...
${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude/IMU -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
